...
namespace ZeissDataIngestion.Services
{
    public class MachineEventService : IHostedService
    {
        private readonly ILogger<MachineEventService> _logger;
        private readonly ClientWebSocket _webSocket;
        private readonly IMachineDataRepository _repository;

        public MachineEventService(IMachineDataRepository repository,ILogger<MachineEventService> logger)
        {
            _logger = logger;
